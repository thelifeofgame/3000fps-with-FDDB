...
string modelPath ="F://3000fps//3000fps1//model_69//";
string dataPath = "F://3000fps//3000fps1//Datasets//";
...
int main( int argc, const char** argv ){
 ...
 //       for(int j = 0;j <13;j++){
//            cout <<j<<endl;
 ////           circle(image,Point2d(ground_truth_shape(a[j]-1,0),ground_truth_shape(a[j]-1,1)),r,Scalar(0,255,0),2,8,0);
